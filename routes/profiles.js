...
router.patch ('/:id', auth, async (req, res) => {
    ...
    const allowedUpdates = ['fullName','birthDate','city','profilePicture','description','languages','hobbies' ]
    ...
    const {fullName,birthDate,city,description,languages,hobbies} = req.body
    const modifications = {}
